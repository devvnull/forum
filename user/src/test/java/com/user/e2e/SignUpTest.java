...
public class SignUpTest {
    ...
    void input_should_be_provided() throws Exception {
        mockMvc.perform(post("/api/signup")
            ...
            .andExpect(jsonPath("$.errors").value(org.hamcrest.Matchers.hasItem("Username is required")))
            .andExpect(jsonPath("$.errors").value(org.hamcrest.Matchers.hasItem("Last name is required")))
            .andExpect(jsonPath("$.errors").value(org.hamcrest.Matchers.hasItem("First name is required")))
            .andExpect(jsonPath("$.errors").value(org.hamcrest.Matchers.hasItem("Password is required")))
            .andExpect(jsonPath("$.errors").value(org.hamcrest.Matchers.hasItem("Password confirmation is required")))
            .andReturn();
    }
    ...
    void username_should_be_in_between_5_and_50_characters_long() throws Exception {
        ...
        mockMvc.perform(post("/api/signup")
            ...
            .content(requestBody))
            .andExpect(status().isBadRequest())
            .andExpect(jsonPath("$.errors").value(org.hamcrest.Matchers.hasItem("Username must be within 5 and 50 characters long")))
            .andReturn();
        ...
        mockMvc.perform(post("/api/signup")
            ...
            .content(requestBody))
            .andExpect(status().isBadRequest())
            .andExpect(jsonPath("$.errors").value(org.hamcrest.Matchers.not("Username must be within 5 and 50 characters long")))
            .andReturn();
    }
    ...
    void username_should_be_alphanumeric() throws Exception {
        ...
        mockMvc.perform(post("/api/signup")
            ...
            .content(requestBody))
            .andExpect(status().isBadRequest())
            .andExpect(jsonPath("$.errors").value(org.hamcrest.Matchers.hasItem("Username must be alphanumeric")))
            .andReturn();
    }
    ...
    void username_must_be_unique() throws Exception {
        ...
        mockMvc.perform(post("/api/signup")
            ...
            .content(requestBody))
            .andExpect(status().isBadRequest())
            .andExpect(jsonPath("$.errors").value(org.hamcrest.Matchers.hasItem("Username must be unique")))
            .andReturn();
    }
    ...
    void password_should_be_in_between_8_and_250_characters_long() throws Exception {
        ...
        mockMvc.perform(post("/api/signup")
            ...
            .content(requestBody))
            .andExpect(status().isBadRequest())
            .andExpect(jsonPath("$.errors").value(org.hamcrest.Matchers.hasItem("Password must be within 8 and 250 characters long")))
            .andReturn();
        ...
        mockMvc.perform(post("/api/signup")
            ...
            .content(requestBody))
            .andExpect(status().isBadRequest())
            .andExpect(jsonPath("$.errors").value(org.hamcrest.Matchers.not("Password must be within 8 and 250 characters long")))
            .andReturn();
    }
    ...
    void password_should_contain_at_least_1_lower_case_and_uppercase_char_and_number_and_special_char() throws Exception {
        ...
        signUpRequest.setPassword("password");
        String requestBody = objectMapper.writeValueAsString(signUpRequest);
        String message = "Password must contain at least one uppercase letter, one lowercase, one number, one special character";
